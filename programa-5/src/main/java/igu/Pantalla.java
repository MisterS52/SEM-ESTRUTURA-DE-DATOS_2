    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            if (vehiculoSeleccionado == 1) {
                ...
                resultado = listaTransporte.mostrarElementosPorClaseYLinea("Micro", lineaSeleccionada);
            } else if (vehiculoSeleccionado == 2) {
                // Mostrar los trenes de la línea seleccionada
                resultado = listaTransporte.mostrarElementosPorClaseYLinea("Tren", lineaSeleccionada);
            } else {
