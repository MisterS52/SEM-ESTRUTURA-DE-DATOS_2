...
int main()//funcion principal
{
	...
	cout<<"\n\t\t\t &TRANSPORTE DE GUADALAJARA\n\n";
	cout<<"\t\t\t\t   -Insertar-\n";
	cout<<"\tQue transporte es: 1(Tren) 2(Macro buss):";cin>>R;
	switch(R)
	{
    case 1:
        {

            string x,A,Z,Q,a,z,za,az;
	cout<<"\tCual nombre de la linea del tren:";cin>>A;
	cout<<"\tDeque linea es del tren:";cin>>Z;
	cout<<"\tDomicilio de la estacion:";cin>>a;
	Q=(" ");
	x=A+Q+Z+Q+a;
    ...
    case 2:
        {
            ...
            string x,A,Z,Q;
	cout<<"\tCual nombre de la linea del macro buss:";cin>>A;
	cout<<"\tDeque linea es del macro buss:";cin>>Z;
	Q=(" ");
	x=A+Q+Z;
	//cout<<"\tCual nombre del perro y raza:";cin>>x;
	cout<<"\t1-Al inicio\n\t2-Al final\n\t3-Escojer:\n\t";cin>>y;
